...
public class ExpandableListAdapter extends BaseExpandableListAdapter {
	...
	public Object getChild(int groupPosition, int childPosititon) {
		return this.animalChild.get(this.animalHeader.get(groupPosition)).get(
				childPosititon);
	...
	public View getChildView(int groupPosition, final int childPosition,
		...
		if (convertView == null) {
			...
			convertView = infalInflater.inflate(R.layout.activity_list_item,
					null);
		}
	...
	public int getChildrenCount(int groupPosition) {
		...
		if ((animalChild.containsKey(animalHeader.get(groupPosition)) == false)
				|| (animalChild.get(this.animalHeader.get(groupPosition))
						.size() < 2)) {
	...
	public View getGroupView(int groupPosition, boolean isExpanded,
		...
		if (convertView == null) {
			LayoutInflater infalInflater = (LayoutInflater) this._context
					.getSystemService(Context.LAYOUT_INFLATER_SERVICE);
			convertView = infalInflater.inflate(R.layout.activity_list_group,
					null);
		}
